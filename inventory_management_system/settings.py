...
SENDGRID_CHANGE_PASSWORD_TEMPLATE = config("SENDGRID_CHANGE_PASSWORD_TEMPLATE")
SENDGRID_ORDER_CONFIRMATION_TEMPLATE = config("SENDGRID_ORDER_CONFIRMATION_TEMPLATE")
SENDGRID_REGISTER_TEMPLATE = config("SENDGRID_REGISTER_TEMPLATE")
